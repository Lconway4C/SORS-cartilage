# -*- coding: utf-8 -*-
"""
Created on Tue Aug 15 15:06:44 2023
...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  6 19:30:19 2023
...
def plot_decision_boundary2D(clf, X: np.ndarray, y: np.ndarray, classes: list, colormap: np.ndarray,
    ...
    plt.show()
    # plt.savefig("different_offset.svg")
...
violet = '#7F00FF'
greenish = '#7fc97f'
colormap = np.array([violet,brownish,pinkish,greenish])

#establish classes
classes = ['onaxis','so4mm','so8mm', 'so12mm']

# load data again
import pandas as pd
matrix = pd.read_csv('different_offset_pcplot.csv')
